...
if (loginForm) {
    loginForm.addEventListener('submit', async (e) => {
        ...
        // Generar token único de sesión — esto invalida sesiones en otros dispositivos
        const sessionToken = crypto.randomUUID();
        localStorage.setItem('bitgameso_session_token', sessionToken);

        // Guardar token en Supabase para que otros dispositivos lo detecten
        try {
            ...
            console.warn('Error guardando session token:', e);
        }
