...
const TUTORIAL_STEPS = [
    ...
    // PASO 10 — Condición de victoria
    {
        target:   '.pet-aside',
        arrowDir: 'right',
        mascot:   'Para ganar BITGAMESO necesitas tener TODAS las mascotas con 100% de salud. Para desbloquear la siguiente mascota necesitas: tener el dinero suficiente Y que tu mascota actual tenga 100% de salud.',
        waitFor:  'next',
        scrollTo: true,
    },
    // PASO 11 — Final
